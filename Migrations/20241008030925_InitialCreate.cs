        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedSize = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActualPizzas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ActualPizzas_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActualPizzas_Pizzas_SpecialId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PizzaTopping_ActualPizzas_PizzaId",
                        column: x => x.PizzaId,
                        principalTable: "ActualPizzas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActualPizzas_OrderId",
                table: "ActualPizzas",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_ActualPizzas_SpecialId",
                table: "ActualPizzas",
                column: "SpecialId");
